$(document).ready(function(){
    ...
    $(".homepage_tab_wrap").mouseleave(function(){
        $(this).find('.homepage_channel_video_wrap').hide();
    });
    //换一换
    var huanyihuan = 1;
    $(".module-rightcontent").click(function(){
        $("#hot"+huanyihuan).hide();
        if(huanyihuan == 3){
            huanyihuan = 1;
        }else{
        ...
        $("#hot"+huanyihuan).show();
        $(".hotgrow .eclazy").lazyload({effect: "show"});
    });
    //主题切换
    ...
    function changeColor(skinName){
        ...
        $("#cssfile").attr('href','/template/ec_TV/css/'+skinName+'.css');
